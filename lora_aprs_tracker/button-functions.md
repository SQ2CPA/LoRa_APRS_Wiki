...
🛒 [Product details](https://go.lora-aprs.pl/product/lilygo-t-beam-sx1278){:target="_blank"}
...
- **Middle Button:** This is the **user button**.
    - A **short press** will switch to the next screen. If you are using the `display timeout` feature, a short press will also wake up the screen. For more information about the display and screens, see [Display](/lora_aprs_tracker/display/).
...
🛒 [Product details](https://go.lora-aprs.pl/product/heltec-wireless-tracker){:target="_blank"}
...
- **Left Button:** This is the primary **user button**.
    - A **short press** will switch to the next screen or wake up the screen if it has timed out. For more information about the display and screens, see [Display](/lora_aprs_tracker/display/).
    - A **double press** will enter or exit the on-screen menu.
...
🛒 [Product details](https://go.lora-aprs.pl/product/lilygo-t-beam-supreme){:target="_blank"}
